...
LD_LIBRARY_PATH="$PACKAGES/$NAME/embedded/lib/python3.8/lib-dynload:$LD_LIBRARY_PATH"
LD_LIBRARY_PATH="$PACKAGES/$NAME/embedded/lib/python3.8/site-packages:$LD_LIBRARY_PATH"
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH

# Python modules
PYTHONPATH=${PYTHONPATH:-''}
PYTHONPATH="$PACKAGES/$NAME/embedded/lib/python3.8:$PYTHONPATH"
PYTHONPATH="$PACKAGES/$NAME/embedded/lib/python3.8/site-packages:$PYTHONPATH"
...
PYTHONPATH="$PACKAGES/$NAME/embedded/lib/python3.8/lib-dynload:$PYTHONPATH"
